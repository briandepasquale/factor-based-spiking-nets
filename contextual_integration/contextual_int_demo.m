...
vJsbar = spiking_network('CI','demean',Tdemean,V,emg);

%% Train with RLS

TRLS = 300; %number of trials for doing RLS
[w,W] = spiking_network('CI','train',TRLS,V,emg,vJsbar);

%% Test

Ttest = 100; %number of trials for testing
ERR_RLS = spiking_network('CI','test',Ttest,V,emg,vJsbar,w,W);  
